...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.String(length=50), nullable=False),
        sa.Column("mode", sa.String(length=20), server_default="LIVE", nullable=False),
        sa.Column("telephony_status", sa.String(length=50), server_default="NOT_STARTED", nullable=False),
        sa.Column("ai_state", sa.String(length=50), server_default="IDLE", nullable=False),
        sa.Column("media_state", sa.String(length=50), server_default="NO_MEDIA", nullable=False),
        sa.Column("asterisk_channel_id", sa.String(length=100), nullable=True),
        sa.Column("asterisk_unique_id", sa.String(length=100), nullable=True),
        sa.Column("telephony_provider", sa.String(length=50), nullable=True),
